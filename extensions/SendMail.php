...
class SendMail
{
    ...
    public function sendKeyCodeMail($mail, $mobile, $code)
    {
        ...
        try {
            ...
            if ($type == 1) {
                $mobileMsg = '【华美互动】尊敬的用户，您己成功购买的华美一元外教课程，请前往注册确认绑定的手机号 ' . $data['url'] . ' 当天即可学习，3天无理由退款！';
            } else {
                $mobileMsg = '【华美互动】尊敬的用户，您购买的华美一元外教学习兑换码已生成' . $data['code'] . ',请前往兑换页' . $data['url'] . '将兑换码复制拷贝并注册下载当天即可登录学习，3天无理由退款！';
            }
            return [
                'status' => 1,
